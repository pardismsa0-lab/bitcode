...
export const courses: Course[] = [
  ...
  { id: "web", title: "طراحی و توسعه وب؛ از مرورگر تا سرور", cat: "web", level: "متوسط", hours: 64, sessions: 36, students: 4150, rating: 4.9, price: 2650000, popular: true, instructor: "مهندس نگار رستمی", skills: ["HTML معنایی و CSS", "ریسپانسیو و Flexbox", "REST API", "استراتژی‌های رندر"], hue: "amber" },
...
export const phases: Phase[] = [
  ...
  { id: 6, term: "فاز ۶", title: "توسعه وب فول‌استک", weeks: 12, desc: "با مفاهیم عمیق وب، React و Node.js یک محصول واقعی از دیتابیس تا رابط کاربری می‌سازی و دیپلوی می‌کنی.", tags: ["مفاهیم وب و رندر", "React", "Node.js", "REST API"], hue: "amber" },
